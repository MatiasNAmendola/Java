...
public class JugadorDao {
	...
	public static final String dbname="tateti", user="root", pass="root";
	public Statement st;
	...
	// El método conectar realiza la conexión con la BBDD MySQL 'tateti'
	...
	public void mostrarRanking() {
		try {
			...
			ResultSet rs = st.executeQuery("select * from jugador ORDER BY partidasGanadas DESC");
